...
public final class ByteUtils {
    ...
    public static int bytesToInt(@Nullable byte[] bytes,int positon) {
        if (bytes == null) {
     ...
     * @return
     */
    public static short bytesToShort(@Nullable byte[] bytes,int positon) {
        if(bytes == null){
     ...
     */
    @NotNull
    public static final String toHexString(@NotNull byte[] values) {
     ...
     */
    @NotNull
    public static final String toHexString(@Nullable byte[] values,int length) {
        if(values == null){
     ...
     */
    @NotNull
    public static byte[] combine(byte[] src, int srcLen, @NotNull byte[] target) {
     ...
     * @return
     */
    public static int setBytes(@NotNull byte[] dst, int offset, @NotNull byte[] values){
    ...
    public static int setBytes(@NotNull byte[] src,int srcPos,short value){
     ...
     */
    @Nullable
    public static byte[] combine(@Nullable byte[] src, @Nullable byte[] target) {
        if(src == null){
            return target;
        }
        if(target == null){
